        ...
        if (message.guild) {
            ...
            if (!channel) {
                ...
                const sent = await message.reply({
                    content: `You\'re about to open a new mail with the details from the replied message, are you sure about that?\nYou have 15 seconds to select one of the buttons below. (${time(Date.now() + 15000, 'R')})`,
                    components: [
                ...
                collector.on('collect', async (i) => {
                    ...
                    switch (i.customId) {
                        case 'create': {
                            ...
                            await i.reply({
                                content: 'Your mail has been successfully created!, please Writedown your query!',
                                ephemeral: true
                            });
